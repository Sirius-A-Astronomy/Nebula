from nebula.models.user import User, validate_username, validate_email
...
class TestValidateUsername:
    ...
    def test_validate_username_with_special_characters(self, empty_app):
        ...
        # assert
        assert result == (False, "Please enter a username without any special characters")
...
class TestValidateEmail:
    ...
    def test_validate_email_already_exists(self, empty_app):
        ...
        user = None
        with empty_app.app_context():
            user_with_email = User(email=email, password='not important', username='not important')
