...
users = [
    ...
    create_user(
        "test_moderator1",
        "unsafe",
        email="test_moderator1@nebula.com",
        access_level=2,
        first_name="Test",
    ...
    create_user(
        "test_moderator2",
        "unsafe",
        email="test_moderator2@nebula.com",
        access_level=2,
        first_name="Test",
...
questions = [
    ...
    Question(
        ...
        course=courses[13],
        subject_tags=[
            subject_tags["Astronomy"],
            subject_tags["Astrophysics"],
    ...
    Question(
        ...
        course=courses[0],
        subject_tags=[subject_tags["Earth Science"], subject_tags["Mathematics"]],
        reviewed=2,
        user=users[3],
    ),
    Question(
        ...
        course=courses[0],
        subject_tags=[subject_tags["Physics"], subject_tags["Quantum Physics"]],
        reviewed=1,
        user=users[2],
    ),
    Question(
    ...
    Question(
        ...
        course=courses[0],
        subject_tags=[subject_tags["Statistics"], subject_tags["Quantum Physics"]],
        reviewed=1,
        user=users[0],
    ),
    Question(
    ...
    Question(
        title="This is the ninth question",
    ...
    Question(
        title="This is the twelfth question",
    ...
    Question(
        title="This is the thirteenth question",
    ...
    Question(
        title="This is the fourteenth question",
    ...
    Question(
        title="This is the fifteenth question",
    ...
    Question(
        title="This is the sixteenth question",
    ...
    Question(
        title="This is the seventeenth question",
    ...
    Question(
        title="This is the eighteenth question",
    ...
    Question(
        title="This is the nineteenth question",
    ...
    Question(
        title="This is the twentieth question",
    ...
    Question(
        title="This is the twenty-first question",
...
Answers = [
    ...
    Answer(
        content="This is the fourth answer",
        question=questions[2],
        sources=["https://www.google.com"],
        user=users[5],
    ),
    Answer(
        content="This is the fifth answer",
        question=questions[3],
        sources=["https://www.google.com"],
        user=users[5],
    ),
    Answer(
        content="This is the sixth answer",
        question=questions[3],
        sources=["https://www.google.com"],
        user=users[5],
    ),
    Answer(
        content="This is the seventh answer",
        question=questions[3],
        sources=["https://www.google.com"],
        user=users[5],
    ),
    Answer(content="This is the eighth answer", question=questions[3], user=users[5]),
]


comments = [
    Comment(content="This is the first comment", question=questions[0], user=users[5]),
    Comment(content="This is the second comment", question=questions[0], user=users[4]),
    Comment(content="This is the third comment", question=questions[0], user=users[2]),
    Comment(content="This is the fourth comment", question=questions[0], user=users[5]),
]
