...
const validatePasswordInput = () => {
  const validPassword = validatePassword(password.value, password.confirmation);
...
<template>
  ...
  <form class="flex flex-col gap-2" @submit.prevent="submit">
    ...
    <div class="flex flex-col gap-2">
      <label for="access_level" class="text-xl font-bold">Access Level</label>
      <div>
        <select
          name="access_level"
          id="access_level"
        ...
        >
          ...
          <option
            ...
            :disabled="
              (accessLevel.value >= authenticatedUser.access_level &&
        ...
        <p
          ...
          class="text-sm text-tertiary-text"
        >
          Note: You cannot change the access level of a user with an access
          level equal to or higher than your own.
        </p>
      </div>
    </div>
