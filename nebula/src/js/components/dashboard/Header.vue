  ...
  >
    <div class="container flex flex-row items-center justify-between py-4">
      <button
        ...
        class="text-accent mr-5 -ml-1 rounded-md p-1 md:hidden"
      ...
      <div
        ...
        :class="withSearch ? '' : 'ml-auto w-full'"
      >
        <ul>
          <li class="relative">
            <button
              id="nav-profile-photo"
              class="focus:shadow-outline-purple flex flex-row gap-1 rounded-full align-middle focus:outline-none"
            ...
            >
              ...
              <span class="hidden md:inline" v-if="user">
            ...
            <ul
              ...
              v-keydown-escape="closeProfileMenu"
              class="absolute right-0 mt-2 w-56 space-y-2 rounded-md border border-slate-100 bg-white p-2 text-slate-600 shadow-md dark:border-slate-700 dark:bg-slate-700 dark:text-slate-300"
              aria-label="submenu"
            >
              <li class="flex">
                <a
                  class="inline-flex w-full items-center rounded-md px-2 py-1 text-sm font-semibold transition-colors duration-150 hover:bg-slate-100 hover:text-slate-800 dark:hover:bg-slate-800 dark:hover:text-slate-200"
                  href="#"
                >
                  <svg
                    class="mr-3 h-4 w-4"
